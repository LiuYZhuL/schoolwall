	...
	<view class="content">
		...
		<view class="post" v-for="post in posts" :key="post.id">
			...
			<view class="post-images" v-if="post.images.length">
				<image class="post-image" v-for="image in post.images" :key="image" :src="image" :class="image-item"
					mode="heightFix" />
			</view>
			...
			<view class="detail-bottom-icons">
				...
				<view class="detail-bottom-icons-box">
					...
					<uni-icons class="comment" type="chatbubble-filled" size="20" style="color: #666;" v-show="!showC"
						@click="comment(item)">
						<text style="font-size: 12px;">895</text>
					</uni-icons>
				</view>
			...
			<view>
				<view v-for="(chatI, index) in chat" :key="index" style="border-top: 1rpx solid black;">
					...
					<view style="padding: 10rpx;">
						...
						<image :src="chatI.message" v-if="chatI.type == 'image'"
							style="max-width: 450rpx; padding: 10rpx;" mode="widthFix"></image>
					</view>
				</view>
